...
function Pagefive() {
  return (
    <div className='md:h-screen px-3 py-2 w-screen bg-white'>
      ...
      <div className='md:relative  md:h-full w-full bg-black items-center  rounded-[50px] flex justify-between flex-col md:flex-row '> 
      ...
      <img className='md:absolute md:hidden  w-[3-vw] mt-60   ' src={apple} alt="" />
