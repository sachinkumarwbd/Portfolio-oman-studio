      ...
      <>
          <div className="h-screen px-3 py-4 w-screen   bg-white">
            ...
            <div className='absolute w-full h-full mt-11  md:p-64 text-center'>
                <h1 className='text-white flex justify-start items-start px-11 md:px-0 flex-col  md:block md:text-[14vw] text-9xl w-full  font-[anzo3]'><span>STEP</span> <span>INTO</span> <span>THE</span> <span>FUTURE.</span></h1>
