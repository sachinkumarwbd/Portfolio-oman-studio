      ...
      <div className=" relative w-full  shadow-gray-700 shadow-lg h-full flex   rounded-[50px]  ">
        <div className=" absolute   justify-between   z-20 text-white py-24 px-16  md:p-24 font-serif  flex ">
          <div className=" sm:w-[50%] w-full text-center items-center  flex flex-col">
            <h1 className="md:text-[13vw] text-[50vw] font-[anzo3]  ">ABOUT</h1>
            <h4 className="text-2xl  ">
              INTUITIVE APPROACH | FUTURE-FOCUSED
            </h4>
            <h4 className="text-2xl">STRATEGY | UNCOMPROMISING DISCIPLINE</h4>
            <p className="text-gray-600 w-full   mt-2 md:w-[70%] text-center">
