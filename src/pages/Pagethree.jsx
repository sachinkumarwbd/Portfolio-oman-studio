      ...
      <div className=" relative w-full  shadow-gray-700 shadow-lg h-full flex   rounded-[50px]  ">
        <div className=" absolute   justify-between   z-20 text-white py-16 px-16  md:p-24 font-serif  flex ">
          <div className="  md:w-[50%] w-full h-full text-center items-center   flex-col">
            ...
            <p className="text-gray-600 w-full mt-6 lg:w-[60%] lg:ml-40 lg:mt-11  md:w-[70%] text-center">
            ...
            <button className=" w-full lg:mt-10 md:w-[50%] mt-1.5 bg-black border-2  px-16 py-1  rounded-full cursor-pointer text-white hover:bg-gray-500">
              Explore
            </button>
          </div>
          ...
          <div className=" md:w-[50%] h-full hidden md:block mt-28  relativejustify-items-center  ">
            <video
              className="md:w-48 w-full h-full md:ml-80 lg:w-80 lg:mb-44 absolute rounded-full "
              playsInline
              loop
              muted
              autoPlay
